        ...
        <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl relative">
                <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
                    <p className="text-2xl font-bold px-2 pt-4">Sun Out, BOGO Out</p>
                    <p className="px-2">Through 8/26</p>
                    <button className="border border-white bg-white text-black mx-2 absolute bottom-4 hover:bg-black hover:text-white hover:border-white duration-150 transition-all">Order Now</button>
                </div>
          ...
          alt='/' className="max-h-[160px] md:max-h-[200px] object-cover w-full rounded-xl"/>
            </div>
             {/* Card */}
      <div className='rounded-xl relative'>
        {/* Overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          ...
          <button className='border-white bg-white text-black mx-2 absolute bottom-4 hover:bg-black hover:text-white hover:border-white duration-150 transition-all'>Order Now</button>
        </div>
        <img
